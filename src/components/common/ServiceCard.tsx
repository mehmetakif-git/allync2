    ...
    >
      <div className="flex-1 w-full">
        <div className="w-full">
          <div className="bg-black/20 backdrop-blur-lg border border-white/10 rounded-3xl p-8 md:p-12 hover:border-white/50 transition-all duration-500 w-full h-full relative overflow-hidden">
            <GlowingEffect
              blur={0}
              borderWidth={1}
              spread={80}

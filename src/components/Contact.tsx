...
export const Contact: React.FC<ContactProps> = ({ language }) => {
  ...
  return (
    <section className="py-8 md:py-12 relative bg-black">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-12 max-w-6xl mx-auto">
          ...
          <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 lg:p-8">
            ...
            <form className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full btn-premium px-6 py-4 rounded-lg font-semibold text-white flex items-center justify-center group min-h-[50px]"
              >
                {t.getMyDemo}
